...
export default async function AchievementDetailPage({ params }: PageProps) {
    ...
    const nextAchievement =
        currentIndex < achievements.length - 1 ? achievements[currentIndex + 1] : null;
            ...
            <section className="relative">
                ...
                <div className="absolute inset-0 h-[50vh] overflow-hidden">
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        <div className={`absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-linear-to-br ${achievement.accentColor} opacity-10 blur-3xl`} />
                        <div className={`absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full bg-linear-to-br ${achievement.accentColor} opacity-15 blur-3xl`} />
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-4xl">
                    ...
                    <BlurFade delay={0.3} inView direction="up">
                        <div className="flex flex-col gap-4 sm:flex-row sm:justify-between">
                            {prevAchievement ? (
                                <Link href={`/achievements/${prevAchievement.slug}`} className="group">
                            ...
                            {nextAchievement && (
                                <Link href={`/achievements/${nextAchievement.slug}`} className="group">
                                    <Button variant="outline" className="w-full gap-2 sm:w-auto">
