            ...
            >
                ...
                <div className="mb-5">
                    <div className="flex items-start justify-between gap-4 mb-2">
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold leading-tight">{experience.company}</h3>
                        {isCurrentWorkplace && (
                    ...
                    <p className="text-base lg:text-lg font-semibold text-foreground/90 mb-1">{experience.position}</p>
                    <time
