...
export const workExperiences: WorkExperience[] = [
    {
        ...
        technologies: ['Node.js', 'Express.js', 'MongoDB', 'Aadhar eSign', 'CDAC Integration']
    },
    {
        id: 'cofount-labs',
        ...
        technologies: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'TypeScript', 'Payment Integration', 'Authentication']
    },
    {
        id: 'brototype',
        company: 'Brototype',
        ...
        technologies: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'JavaScript', 'Agile Development']
    }
];
