...
function FooterSection() {
  ...
  return (
    <footer
      className="footer-bg relative border 2xl:h-[550px] h-fit lg:pb-20 mb-8 w-[95%] mx-auto rounded-lg overflow-hidden radial-gradient-bg
        ...
        <div className="sm:block flex sm:mt-0 mt-4 gap-2 sm:w-auto w-full sm:space-y-2 relative z-10">
          {socialLinks.map((social) => (
            <Link
              ...
              className="bg-background sm:w-auto w-full grid place-content-center h-28 2xl:p-10 p-5 rounded-lg hover:bg-muted transition-colors"
